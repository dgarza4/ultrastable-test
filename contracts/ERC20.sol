...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping(address=>bool) blacklisted; // To record blacklisted addresses
    ...
    function blacklist(address _address)  public{
        ...
        require(blacklisted[_address] != true, "Address already blacklisted");
        blacklisted[_address] = true;
    }

    function escapeBlacklist(address _address)  public{
        require(msg.sender == _owner, "Only owner can access this function");
        require(blacklisted[_address] != false, "Address is not blacklisted");
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        uint256 fee = (amount*10)/100; //10% fee on transfer;

        _burn(msg.sender,(fee*5)/100); // 5% fee burned and the remaining 5% remains in this smart contract and can be used anywhere
